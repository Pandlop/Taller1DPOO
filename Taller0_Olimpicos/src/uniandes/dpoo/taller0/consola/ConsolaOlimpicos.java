...
public class ConsolaOlimpicos
{
	...
	public void ejecutarAplicacion()
	{
		...
		while (continuar)
		{
			try
			{
				...
				// Nueva opcion para informar el nombre del pais que representa un atleta.
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais el cual representa un atleta.");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	/**
	 * Le muetra al usuario el nombre del pais que representa un atleta
	 */
	private void ejecutarPaisAtleta()
	{
		System.out.println("\n" + "Pais representado por un atleta" + "\n");
		String atleta = input("Ingrese el nombre del atleta que desea buscar").toLowerCase();
		String nombrePais = calculadora.atletaPais(atleta);
		
		if (nombrePais == null)
		{
			System.out.println("El atleta ingresado no existe.");
		}
		else
		{
			System.out.println("El atleta " + atleta + " representa a " + nombrePais);
		}
